<template>
    <GuestLayout>
        ...
        >
            ...
            <!-- Main Content -->
            <div
                class="relative container mx-auto px-4 pt-24 pb-16 sm:px-6 lg:px-8"
            >
                <div class="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div class="text-center lg:text-left space-y-8">
                        <div class="space-y-4">
                            ...
                            >
                                Creating unforgettable culinary experiences for
                                your special moments. From elegant catering to
                                custom-crafted cakes, we bring your celebrations
                                to life.
                            </p>
                        </div>
                        ...
                        >
                            <button
                                class="px-8 py-4 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-full font-medium transform transition-all duration-300 hover:scale-105 hover:shadow-lg flex items-center justify-center space-x-2 group"
                    ...
                    <div class="relative">
                        <div class="relative rounded-2xl overflow-hidden group">
                            <img
                                ...
                                class="w-full h-full object-cover rounded-2xl transform transition-transform duration-700 group-hover:scale-110"
                            />
                            <!-- Floating Elements -->
                            <div
                                class="absolute -top-6 -right-6 bg-white p-4 rounded-xl shadow-xl transform rotate-12 animate-float"
                            >
                                <img
                                ...
                                />
                                <p
                                    class="mt-2 text-center font-medium text-gray-900"
                                >
                                    Custom Cakes
                                </p>
                            </div>
                            <div
                                class="absolute -bottom-4 -left-4 bg-white p-4 rounded-xl shadow-xl transform -rotate-6 animate-float animation-delay-1000"
                            >
                                <img
                                    src="/api/placeholder/80/80"
                                    alt="Catering"
                        ...
                        <!-- Stats -->
                        <div
                            class="absolute bottom-4 left-1/2 transform -translate-x-1/2 bg-white/80 backdrop-blur-md rounded-2xl p-6 shadow-lg"
                        >
